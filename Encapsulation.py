#Encapsulation helps to protect the data and methods of an object from unauthorized access
# and modification. It is a way to achieve data abstraction, which means that the
# implementation details of an object are hidden from the outside world, and only the essential information is exposed.
